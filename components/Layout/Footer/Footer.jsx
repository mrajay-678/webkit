  ...
  return (
    ...
    >
      ...
      <div className={styles.inner}>
        ...
        >
          <Image
            src={require("../../../public/icon/logo.svg")}
            alt="LOGO AJAY"
            className={`web-logo ${styles.webLogo}`}
          />
          <div className={styles.copyright}>
            &copy; {currentYear} {commonConfig.personal.name} {commonConfig.personal.surname}
            <br />
